...
//Code Here
let postTaxPrices = prices.map(element => prices * 1.07)

// I'm proud of myself so I made a kitten. =^.^=
...
//Code Here
let totalPopulation = populations.reduce((acc, element) => {return acc + element})
